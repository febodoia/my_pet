...
import 'package:my_pet/src/view/meus_pets/perfil_pet/PetDetailPage.dart';
...
class PetCard extends StatelessWidget {
            ...
            new Row(
              children: <Widget>[
                new Icon(Icons.filter_vintage,
                    size: 14.0, color: ColorsTheme.petDistance),
                new Text(pet.tipo, style: TextStyles.petDistance),
                new Container(width: 24.0),
                new Icon(Icons.favorite,
                    size: 14.0, color: ColorsTheme.petDistance),
                new Text(pet.idade.toString(), style: TextStyles.petDistance),
              ],
            )
          ],
        ),
  ...
  _navigateTo(context, String id) {
    Routes.navigateTo(context, '/detail/${pet.id}',
