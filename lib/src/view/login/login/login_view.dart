...
import 'package:my_pet/src/app/components/alertDialog.dart';
import 'package:my_pet/src/app/my_app.dart';
import 'package:my_pet/src/service/login/login_service.dart';
...
//      print(scrollPercent);
  ...
  _clickButton(BuildContext context) async {
    ...
    print('login $login e senha $password');

    var user = await LoginService.login(login, password);

    if( user != null){
      Navigator.of(context).pushNamed('/home');
    } else {
      alert(context, "Os dados estão incorretos.");
    }
